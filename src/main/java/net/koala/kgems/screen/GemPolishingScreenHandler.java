...
import net.koala.kgems.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingScreenHandler extends ScreenHandler {
    ...
    public GemPolishingScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buff) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(buff.readBlockPos()),
