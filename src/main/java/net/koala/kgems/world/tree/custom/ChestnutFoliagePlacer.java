package net.koala.kgems.world.tree.custom;
...
public class ChestnutFoliagePlacer extends FoliagePlacer {
    ...
    protected void generate(TestableWorld world, BlockPlacer placer, Random random, TreeFeatureConfig config, int trunkHeight,
        ...
        generateSquare(world, placer, random, config, treeNode.getCenter().up(0), 4, 0, treeNode.isGiantTrunk());
        generateSquare(world, placer, random, config, treeNode.getCenter().up(1), 3, 0, treeNode.isGiantTrunk());
